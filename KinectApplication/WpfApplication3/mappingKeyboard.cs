...
{
    public partial class mappingKeyboard : UserControl
    {
        public mappingKeyboard()
        {
            InitializeComponent();
        }
        internal static class NativeMethods
        {
            ...
            internal const int KeteventKeyup = 0x0002;
            internal const int KeyeventScancode = 0x0008;
            ...
            //Importing various Win32 APIs thats we need for input
        ...
        public static class Keyboard
        {
            ...
            //Reset the system keyboard to a clean state.
            ...
            private static void SendKeyboardInput(Key key, bool press)
            {
                ...
                {
                    dwFlags |= NativeMethods.KeyeventScancode;
                }
                if (!press)
                {
                    dwFlags |= NativeMethods.KeteventKeyup;
                }
        ...
        private void mappingKeyboard_Load(object sender, EventArgs e)
        {
